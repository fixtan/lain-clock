...
//const appWindow = tauriWindow.getCurrent(); // これで現在のウィンドウインスタンスを取得
const { Window } = window.__TAURI__;
//const appWindow = Window.getCurrent ? Window.getCurrent() : window.__TAURI__.window.appWindow;
...
// applySize 関数を以下のように修正
  ...
  const initialSize = savedSize ? parseInt(savedSize) : 200;
